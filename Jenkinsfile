    ...
    stage('Build Docker Image'){
     ...
     stage('Push NGINX Docker Image'){
		steps {
           ...
           bat 'docker tag clx-repx:${BUILD_NUMBER} 310643530327.dkr.ecr.us-west-2.amazonaws.com/clx-repx'
           //bat 'docker tag clx-repx:latest 310643530327.dkr.ecr.us-west-2.amazonaws.com/clx-repx:latest'
			...
			bat 'docker push 310643530327.dkr.ecr.us-west-2.amazonaws.com/clx-repx'
